...
simdata_jn <- data.frame(meandeg = 1,meanduration = a1,nodes = b1, act = 9.6, transmission = 0.05, recovery = 0.05, 
                      infected = 1, recovered = 0, sims = 10,proportion = c1,peak.inf = round(d1, 0), shortprop = f1, concurrency = '0%')

result_jn <- data.frame('Mean Degree' = 1, 'Mean Duration' = a1, 'Nodes' = b1, 'Act Rate' = 9.6, 'Trans.Prob.' = 0.05, 'Recovery Rate' = 0.05
